...
const pdfPath = "./alanT.pdf"; 
const loader = new PDFLoader(pdfPath);
const docsList = await loader.load();
//console.log("Contenido del PDF:", docsList);
...
const tool = createRetrieverTool(
  retriever,
  {
    name: "retrieve_alant_ideas",
    description:
      "Busca y devuelve información sobre los escritos de Alan Turing y siempre responde en español. No uses tu propio conocimiento, solo usa las tools",
  },
);
const tools = [tool];
...
const inputs = {
  messages: [
    new HumanMessage(
      "que es pizza y donde estas sacando la informacion",
    ),
  ],
};
let finalState;
